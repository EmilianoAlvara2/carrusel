/**(function(){
    ...
    arrowAdelante.addEventListener('clic', ()=>changePosition(1));
    arrowatras.addEventListener('clic', ()=>changePosition(-1));

    function changePosition(change){
        const currentElement = Number(document.querySelector('slider_body_show'))
        ...
        slider[currentElement-1].classList.toggle('slider_body_show')
        slider[value-1].classList.toggle('slider_body_show')
    }
